//! ScadStudio: assemble 3D models out of parametric primitives by typing exact
...
fn main() -> eframe::Result<()> {
    ...
    let settings = scadstudio_core::config::load_settings();
    let mut viewport = egui::ViewportBuilder::default()
        .with_title(app::APP_NAME)
        .with_app_id("net.scadstudio.ScadStudio")
