...
#[test]
fn a_landscape_unions_with_a_shape_that_overlaps_it() {
...
#[test]
fn a_union_survives_an_operand_of_several_separate_solids() {
...
#[test]
fn a_box_is_twelve_triangles_and_eight_vertices() {
...
#[test]
fn a_convex_operand_cuts_only_where_its_surface_is() {
...
#[test]
fn a_cap_meeting_a_plate_off_axis_is_closed() {
...
#[test]
fn an_inverted_convex_clipper_keeps_the_right_side() {
